...
<?php if (isset($_POST['register'])){
    ...
    $sql="select * from users where admin_id = '".$_SESSION['sess_admin_login_id']."' ";
    $result = db_query($sql) or die(db_error($sql));
    if ($line = mysql_fetch_array($result)) {
        $db_adm_password=$line['admin_pwd'];
        if($db_adm_password == $old_password) {
            $sql="update pkg_admin set admin_pwd = '$password' where admin_id = '".$_SESSION['sess_admin_login_id']."'";
            ...
            <div class="body-inner">
                <div class="card bg-white">
                    <div class="card-content">
                        ...
                        <form class="form-horizontal ng-pristine ng-valid" method="POST" action="/register.php">
                            <fieldset>
