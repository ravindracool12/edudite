...
if(is_post_back()) {
	...
	if(is_array($arr_pages_ids)) {
		...
		if(isset($_REQUEST['Delete']) || isset($_REQUEST['Delete_x']) ) {
			$sql = "delete from edu_user where user_id in ($str_user_ids)";
			db_query($sql);
		} else if(isset($_REQUEST['Activate']) || isset($_REQUEST['Activate_x']) ) {
			$sql = "update edu_user set user_status = 'Active' where user_id in ($str_user_ids)";
			db_query($sql);
		} else if(isset($_REQUEST['Deactivate']) || isset($_REQUEST['Deactivate_x']) ) {
			$sql = "update edu_user set user_status = 'Inactive' where user_id in ($str_user_ids)";
			db_query($sql);
		}
	}
			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						<li><a href="users_f.php"><strong style="color:#F00;">Add New User</strong></a></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
											...
											<table id="datable_1" class="table table-hover display  pb-30" >
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                              ...
                                                              <td nowrap="nowrap"><?=$user_date?></td>
                                                              <td nowrap="nowrap"><?=$user_status?></td>
                                                              <td nowrap="nowrap"><a href="users_f.php?user_id=<?=$user_id?>"><img src="../img/edit.png" alt="Edit" width="16" height="16" border="0" /></a></td>
                                                              <td nowrap="nowrap"><input name="arr_user_ids[]" type="checkbox" id="arr_user_ids[]" value="<?=$user_id?>" /></td>
                                                        </tr>
