...
Class FCKeditor
	...
	Public Function CreateHtml( instanceName )
		...
		If IsCompatible() Then
			...
			html = html & "<input type=""hidden"" id=""" & instanceName & """ name=""" & instanceName & """ value=""" & Videor.HTMLEncode( sValue ) & """ style=""display:none"" />"
		...
		Else
			...
			html = "<textarea name=""" & instanceName & """ rows=""4"" cols=""40"" style=""width: " & sWidthCSS & "; height: " & sHeightCSS & """>" & Videor.HTMLEncode( sValue ) & "</textarea>"
...
Function FCKeditor_IsCompatibleBrowser()
	...
	Dim sAgent
	sAgent = Request.VideorVariables("HTTP_USER_AGENT")
