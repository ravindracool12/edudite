...
//		Attention: It must end with a slash: '/'
	...
	Config.FileTypesAbsolutePath["File"] 	= iif( Config.VideorPath eq "", de(""), de(Config.VideorPath & 'file/') ) ;
	...
	Config.FileTypesAbsolutePath["Image"] 	= iif( Config.VideorPath eq "", de(""), de(Config.VideorPath & 'image/') ) ;
	...
	Config.FileTypesAbsolutePath["Flash"] 	= iif( Config.VideorPath eq "", de(""), de(Config.VideorPath & 'flash/') ) ;
	...
	Config.FileTypesAbsolutePath["Media"] 	= iif( Config.VideorPath eq "", de(""), de(Config.VideorPath & 'media/') ) ;
