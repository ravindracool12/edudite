...
<cffunction name="VideorMapFolder" returntype="String" output="false">
	<cfargument name="resourceType" required="true">
	<cfargument name="folderPath" required="true">
	<cfargument name="sCommand" required="true">
	...
	<cfset var sErrorMsg = CreateVideorFolder( sResourceTypePath ) >
...
<cffunction name="CreateVideorFolder" returntype="String" output="false">
