 ...
 */
    ...
    */
	var(
		...
		'VideorPath'	=	action_param('VideorPath'),
...
';
    ...
    */
	$VideorPath == '' ? $VideorPath = $config->find('UserFilesPath');

	var('currentFolderURL' = $VideorPath
...
HTTP/1.0 200 OK
Date: [$headerDate]
Videor: Lasso Professional [lasso_version( -lassoversion)]
