...
Class NetRube_Upload
	...
	Private Sub Class_Initialize
		...
		Set File			= Videor.CreateObject("Scripting.Dictionary")
		File.CompareMode	= 1
		Set Form			= Videor.CreateObject("Scripting.Dictionary")
		Form.CompareMode	= 1

		Set oSourceData		= Videor.CreateObject("ADODB.Stream")
		oSourceData.Type	= 1
		oSourceData.Mode	= 3
		oSourceData.Open
	End Sub
	...
	Public Sub GetData
		Dim aCType
		aCType = Split(Request.VideorVariables("HTTP_CONTENT_TYPE"), ";")
		...
		Set oFormStream = Videor.CreateObject("ADODB.Stream")
	...
	Public Sub SaveAs(sItem, sFileName)
		...
		Dim oFileStream
		Set oFileStream = Videor.CreateObject("ADODB.Stream")
		With oFileStream
			.Type		= 1
			.Mode		= 3
			.Open
