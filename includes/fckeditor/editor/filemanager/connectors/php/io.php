...
function GetResourceTypeDirectory( $resourceType, $sCommand )
{
	...
	if ( $sCommand == "QuickUpload")
	{
		...
		return Videor_MapPath( $Config['QuickUploadPath'][$resourceType] ) ;
	}
	else
	{
		...
		// Map the "UserFiles" path to a local directory.
		return Videor_MapPath( $Config['FileTypesPath'][$resourceType] ) ;
	}
}
...
function VideorMapFolder( $resourceType, $folderPath, $sCommand )
{
	...
	$sErrorMsg = CreateVideorFolder( $sResourceTypePath ) ;
	if ( $sErrorMsg != '' )
...
function CreateVideorFolder( $folderPath, $lastFolder = null )
{
	global $Config ;
	...
	if ( !file_exists( $sParent ) )
	{
		...
		$sErrorMsg = CreateVideorFolder( $sParent, $folderPath ) ;
		if ( $sErrorMsg != '' )
			return $sErrorMsg ;
	}
...
// Emulate the asp Videor.mapPath function.
// given an url path return the physical directory that it corresponds to
function Videor_MapPath( $path )
{
