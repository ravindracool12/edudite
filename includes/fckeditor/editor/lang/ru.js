...
BrowseVideorBlocked : "Ресурсы браузера не могут быть открыты. Проверьте что блокировки всплывающих окон выключены.",
...
DlgBtnCancel		: "Отмена",
DlgBtnClose			: "Закрыть",
DlgBtnBrowseVideor	: "Просмотреть на сервере",
